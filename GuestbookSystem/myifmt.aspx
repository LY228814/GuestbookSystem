<%@ Page Title="" Language="C#" MasterPageFile="~/NavMaster.Master" AutoEventWireup="true" CodeBehind="myifmt.aspx.cs" Inherits="GuestbookSystem.myifmt" %>
                    ...
                    <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                        <ItemTemplate>
                            <tr class="mylist">
                                ...
                                <asp:HiddenField ID="HF1" runat="server" Value='<%#Eval("Iid")%>' />
                                <td><%#Eval("Title") %></td>
                                <td><%#Eval("SeeCount") %></td>
